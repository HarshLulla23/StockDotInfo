...
// var symbol1=document.querySelector("#hallo").value;
// console.log(symbol1);
// }
...
// }
function chartdatacall(symbol,symbol1) {
    ...
    chartdatacall(symbol,symbol1);
            ...
            readTextFile("../jsonFiles/" + symbol + ".json", function (text) {
                ...
                for (var key3 in obj2) {
                    if (i < 25) {
                        // labelsNew.push(key3);
                        dataNew1.push(data["Time Series (Daily)"][key3]["4. close"]);
                    }
                    else {
                        break;
                    }
            ...
            readTextFile("../jsonFiles/" + symbol1 + ".json", function (text) {
                var data = JSON.parse(text);
                console.log(data["Meta Data"]["3. Last Refreshed"]);
                // subdate.innerText = data["Meta Data"]["3. Last Refreshed"];
                let i = 0;
                ...
                for (var key3 in obj2) {
                    if (i < 25) {
                        labelsNew.push(key3);
                        dataNew2.push(data["Time Series (Daily)"][key3]["4. close"]);
                    }
                    else {
                        break;
                    }
                ...
                addData(chartData, labelsNew, dataNew1, dataNew2);
            });
    ...
    chartdatacall(symbol,symbol1);
            ...
            readTextFile("../jsonFiles/" + symbol + "Weekly.json", function (text) {
                ...
                for (var key3 in obj2) {
                    if (i < 50) {
                        // labelsNew.push(key3);
                        dataNew1.push( data["Weekly Time Series"][key3]["4. close"]);
                    }
                    else {
                        break;
                    }
            ...
            readTextFile("../jsonFiles/" + symbol1 + "Weekly.json", function (text) {
                var data = JSON.parse(text);
                console.log(data["Meta Data"]["3. Last Refreshed"]);
                // subdate.innerText = data["Meta Data"]["3. Last Refreshed"];
                let i = 0;
                ...
                for (var key3 in obj2) {
                    if (i < 50) {
                        labelsNew.push(key3);
                        dataNew2.push( data["Weekly Time Series"][key3]["4. close"]);
                    }
                    else {
                        break;
                    }
    ...
    chartdatacall(symbol,symbol1);
            ...
            readTextFile("../jsonFiles/" + symbol + "Monthly.json", function (text) {
                ...
                for (var key3 in obj2) {
                    if (i < 25) {
                        // labelsNew.push(key3);
                        dataNew1.push(data["Monthly Time Series"][key3]["4. close"]);
                    }
                    else {
                        break;
                    }
            ...
            readTextFile("../jsonFiles/" + symbol1 + "Monthly.json", function (text) {
                var data = JSON.parse(text);
                console.log(data["Meta Data"]["3. Last Refreshed"]);
                // subdate.innerText = data["Meta Data"]["3. Last Refreshed"];
                let i = 0;
                ...
                for (var key3 in obj2) {
                    if (i < 25) {
                        labelsNew.push(key3);
                        dataNew2.push(data["Monthly Time Series"][key3]["4. close"]);
                    }
                    else {
                        break;
                    }
